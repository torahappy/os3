...
var _hb_blob_create_from_file = Module['_hb_blob_create_from_file'] = makeInvalidEarlyAccess('_hb_blob_create_from_file');
...
var _hb_face_create = Module['_hb_face_create'] = makeInvalidEarlyAccess('_hb_face_create');
var _hb_font_get_glyph = Module['_hb_font_get_glyph'] = makeInvalidEarlyAccess('_hb_font_get_glyph');
var _hb_font_get_glyph_advance_for_direction = Module['_hb_font_get_glyph_advance_for_direction'] = makeInvalidEarlyAccess('_hb_font_get_glyph_advance_for_direction');
var _hb_font_create = Module['_hb_font_create'] = makeInvalidEarlyAccess('_hb_font_create');
var _hb_shape = Module['_hb_shape'] = makeInvalidEarlyAccess('_hb_shape');
...
function assignWasmExports(wasmExports) {
  Module['_hb_blob_create_from_file'] = _hb_blob_create_from_file = createExportWrapper('hb_blob_create_from_file', 1);
  ...
  Module['_hb_face_create'] = _hb_face_create = createExportWrapper('hb_face_create', 2);
  Module['_hb_font_get_glyph'] = _hb_font_get_glyph = createExportWrapper('hb_font_get_glyph', 4);
  Module['_hb_font_get_glyph_advance_for_direction'] = _hb_font_get_glyph_advance_for_direction = createExportWrapper('hb_font_get_glyph_advance_for_direction', 5);
  Module['_hb_font_create'] = _hb_font_create = createExportWrapper('hb_font_create', 1);
  Module['_hb_shape'] = _hb_shape = createExportWrapper('hb_shape', 4);
