...
// alpha
// green: 0.0 when main video, 1.0 when text
// white: 1.0 when main video, 0.0 when test

@group(#{MATERIAL_BIND_GROUP}) @binding(3) var<uniform> green_white_p3_p4: vec4<f32>;
